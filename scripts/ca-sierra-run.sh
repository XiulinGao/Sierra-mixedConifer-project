...
#---~---
export WORK_PATH="${HOME}/fates_grasmort/XXXX/cime/scripts"
export CASE_ROOT="/glade/work/xiugao/Regional-WRF/Cases"
export SIMUL_ROOT="/glade/derecho/scratch/xiugao/Regional-WRF/Simulations"
#---~---
...
export CASE_PREFIX="sierra-climigni-284-spinup-north"
...
export SITE_NAME="ca-SN"
# mesh file (it must be in the SITE_NAME sub-directory).
export HLM_USRDAT_DOMAIN="wrf_CA_unstruct.nc"
#export HLM_USRDAT_DOMAIN="oak-woodland-domain-100523.nc"
# land mask file
#export HLM_USRDAT_MASK="oak-woodland-domain.nc"
#export HLM_USRDAT_MASK="CA-sierra-mesh-240317.nc"
export HLM_USRDAT_MASK="Sierra-northstrip-mesh-240321.nc"
#export HLM_USRDAT_MASK="wrf_CA_grass-woodland.nc"
# Surface data file (it must be in the SITE_NAME sub-directory).
export HLM_USRDAT_SURDAT="wrf-sn-surfdata-cdf5_20240316.nc"
# Initiation file for model start from prrevious restart file  
#export HLM_FINIDAT="oak-test_CLM_FATES.clm2.r.1965-01-01-00000.nc"
export HLM_FINIDAT=""
# Prescribed ignition file for SPITFIRE mode 3
#export FIRE_IGNI_FILE="/glade/work/xiugao/fates-input/ca-SN/ignition/SN_prescribed_ignitions_0.0015perday.nc"
export FIRE_IGNI_FILE=""
# External harvesting data
export HAVST_FILE=""
#export HAVST_FILE="/glade/work/xiugao/fates-input/ca-SN/sierra-harvest_1901-2000-landuse_20240322.nc"
...
#---~---
export FATES_PARAMS_BASE="ca-sierra-rxfire_pollychange_norxfire.cdl"
#---~---
...
#
#---~---
prm_settings=("fates_pftname                         1             pine"
	      "fates_pftname                         2    incense_cedar"
	      "fates_pftname                         3        white_fir"
	      "fates_alloc_storage_cushion           1     1.19478986691562"
	      "fates_alloc_storage_cushion           2     1.06737274248153"
	      "fates_alloc_storage_cushion           3     1.06737274248153"
#              "fates_allom_amode                      1         2"
              "fates_allom_agb1                       1         0.25"
	      "fates_allom_agb1                       2         0.25"
	      "fates_allom_agb1                       3         0.25"
	      "fates_allom_agb2                       1          0.7"
	      "fates_allom_agb2                       2          0.7"
              "fates_allom_agb2                       3          0.7"
              "fates_allom_agb3                       1            2"
	      "fates_allom_agb3                       2            2"
	      "fates_allom_agb3                       3            2"
              "fates_allom_agb4                       1          1.9"
	      "fates_allom_agb4                       2          1.9"
	      "fates_allom_agb4                       3          1.9"
#              "fates_allom_lmode                      1         2"
              "fates_allom_d2bl1                      1         0.2"
	      "fates_allom_d2bl1                      2         0.2"
	      "fates_allom_d2bl1                      3         0.2"
              "fates_allom_d2bl2                      1         1.5"
	      "fates_allom_d2bl2                      2         1.5"
	      "fates_allom_d2bl2                      3         1.7"
              "fates_allom_d2bl3                      1        0.75"
	      "fates_allom_d2bl3                      2        0.75"
	      "fates_allom_d2bl3                      3         0.7"
              "fates_allom_d2ca_coefficient_max       1      0.6568464"
	      "fates_allom_d2ca_coefficient_max       2      0.6568464"
	      "fates_allom_d2ca_coefficient_max       3      0.6568464"
	      "fates_allom_d2ca_coefficient_min       1      0.3381119"
	      "fates_allom_d2ca_coefficient_min       2      0.3381119"
	      "fates_allom_d2ca_coefficient_min       3      0.3381119"
#              "fates_allom_hmode                      1         2"
              "fates_allom_d2h1                       1           1.45"
	      "fates_allom_d2h1                       2           1.45"
	      "fates_allom_d2h1                       3           1.45"
              "fates_allom_d2h2                       1             -1"
              "fates_allom_d2h2                       2             -1"
	      "fates_allom_d2h2                       3             -1"
#             "fates_allom_d2h3                       1         0.855482"
	      "fates_allom_la_per_sa_int              1            0.4"
	      "fates_allom_la_per_sa_int              2            0.4"
	      "fates_allom_la_per_sa_int              3            0.4"
	      "fates_fire_bark_scaler                 1       0.052896"
	      "fates_fire_bark_scaler                 2      0.051073321338851"
	      "fates_fire_bark_scaler                 3      0.0420092252923697"
	      "fates_allom_crown_depth_frac           2         0.9"
	      "fates_allom_crown_depth_frac           3         0.9"
	      "fates_allom_fnrt_prof_a                1           5"
	      "fates_allom_fnrt_prof_a                2           5"
	      "fates_allom_fnrt_prof_a                3           5"
	      "fates_allom_fnrt_prof_b                1           1"
	      "fates_allom_fnrt_prof_b                2           1"
	      "fates_allom_fnrt_prof_b                3           1"
              "fates_leaf_slamax                      1         0.00826309104147367"
	      "fates_leaf_slamax                      2         0.00950545330844672"
	      "fates_leaf_slamax                      3         0.0105791760492036"
	      "fates_leaf_slatop                      1         0.00721800129883923"
	      "fates_leaf_slatop                      2         0.0075906626629556"
	      "fates_leaf_slatop                      3         0.00929830687653025"
              "fates_leaf_stomatal_slope_ballberry    1         9.81169483996928"
	      "fates_leaf_stomatal_slope_ballberry    2         9.87132725174384"
	      "fates_leaf_stomatal_slope_ballberry    3         9.89338666089619"
	      "fates_mort_bmort                       1         0.0075"
	      "fates_mort_bmort                       2         0.0075"
	      "fates_mort_bmort                       3         0.0075"
	      "fates_mort_hf_sm_threshold             1         0.3"
	      "fates_mort_hf_sm_threshold             2         0.3"
	      "fates_mort_hf_sm_threshold             3         0.3"
	      "fates_mort_scalar_cstarvation          1         0.569430560036562"
	      "fates_mort_scalar_cstarvation          2         0.500714426506064"
	      "fates_mort_scalar_cstarvation          3         0.500714426506064"
	      "fates_recruit_seed_alloc               1         0.0653665698971599"
	      "fates_recruit_seed_alloc               2         0.0653665698971599"
	      "fates_recruit_seed_alloc               3         0.0653665698971599"
	      "fates_recruit_seed_alloc_mature        1         0.429906235309318"
	      "fates_recruit_seed_alloc_mature        2         0.226477998240115"
	      "fates_recruit_seed_alloc_mature        3         0.226477998240115"
	      "fates_recruit_seed_dbh_repro_threshold 1         33.5871419264004"
	      "fates_recruit_seed_dbh_repro_threshold 2         33.5871419264004"
	      "fates_recruit_seed_dbh_repro_threshold 3         33.5871419264004"
	      "fates_nonhydro_smpsc                   1         -368336.8625"
	      "fates_nonhydro_smpsc                   2         -698450.895"
	      "fates_nonhydro_smpsc                   3         -385119.039"
	      "fates_wood_density                     1         0.445064"
	      "fates_wood_density                     2         0.446622520401228"
	      "fates_wood_density                     3         0.483220732611198"
	      "fates_turnover_leaf                    1         4.3115"
	      "fates_turnover_leaf                    2         6.37869660655886"
	      "fates_turnover_leaf                    3         15.7295740785443"
	      "fates_leaf_vcmax25top                  1         66.0143893494271"
	      "fates_leaf_vcmax25top                  2         46.129748605861"
	      "fates_leaf_vcmax25top                  3         35.0617446941486"
)
#---~---
...
then
   hlm_settings=("hist_empty_htapes .true."
                 ...
                 "hist_fincl1       'BTRAN','BTRANMN','EFLX_SOIL_GRND',\
                                    ...
                                    'FATES_BGSTRUCT_ALLOC_SZPF','FATES_BURNFRAC','FATES_RXFIRE_BURNFRAC',\
                                    ...
                                    'FATES_MORTALITY_RXCAMBIALBURN_SZPF',\
                                    'FATES_MORTALITY_RXCROWNSCORCH_SZPF', 'FATES_MORTALITY_CROWNSCORCH_SZPF',\
                                    ...
                                    'FATES_MORTALITY_HYDRAULIC_SZPF','FATES_MORTALITY_RXFIRE_SZPF',\
                                    ...
                                    'FATES_RX_BURN_WINDOW',\
                                    'FATES_RXFIRE_INTENSITY_BURNFRAC', 'FATES_RXFIRE_BURNFRAC_AP',\
...
#---~---
./xmlchange NTASKS_ATM=-4    # if use all processors give  -4
...
#DATM_PATH="${SITE_PATH}/ec-earth3-ssp370-2015-2099"
DATM_PATH="/glade/work/xiugao/fates-input/ca-wrf-grassland/CLM1PT_data"

#--- List all files with full path so we can append this to user_nl_datm

#DATM_FILE=$(/bin/ls -m ${DATM_PATH}/{2015..2099}*.nc)
DATM_FILE=$(/bin/ls -m ${DATM_PATH}/{1951..1980}*.nc) 
...
#   Include settings for the prescribed ignition
if ${USE_FATES} && [[ "${FIRE_IGNI_FILE}" != "" ]]
then

    #--- Set external ignition file.
    #---~---
   touch ${USER_NL_HLM}
   echo "stream_fldfilename_lightng = '${FIRE_IGNI_FILE}'" >> ${USER_NL_HLM}
#   echo "stream_meshfile_lightng = '${MESH_FILE}'" >> ${USER_NL_HLM}
#   echo "lightngmapalgo = 'nn'" >> ${USER_NL_HLM}
   echo "stream_year_first_lightng = 1901" >> ${USER_NL_HLM}
   echo "stream_year_last_lightng = 2001" >> ${USER_NL_HLM}
   echo "model_year_align_lightng = 1901" >> ${USER_NL_HLM}
    #---~---

fi

#   Include settings for external harvesting data
if ${USE_FATES} && [[ "${HAVST_FILE}" != "" ]]
then

    #--- Set external harvesting file.
    #---~---
   touch ${USER_NL_HLM}
   echo "do_harvest = .true." >> ${USER_NL_HLM}    
   echo "flanduse_timeseries = '${HAVST_FILE}'" >> ${USER_NL_HLM}
    #---~---
